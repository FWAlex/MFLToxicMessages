...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/BABFrameObservingInputAccessoryView/BABFrameObservingInputAccessoryView.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/DKImagePickerController/DKImagePickerController.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/FW_JSQMessagesViewController/FW_JSQMessagesViewController.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/MBProgressHUD/MBProgressHUD.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/MFL-Common/MFL_Common.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/MFLToxicMessages/MFLToxicMessages.framework"
